...
<nav style="background-color:#00C2D9;" class="navbar navbar-expand-lg justify-content-between fixed-top  ">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul style="float: right" class="navbar-nav me-auto mb-2 mb-lg-0">
          <li  class="nav-item">
            <a style="color: white; font-size:30px;" class="nav-link active" aria-current="page" href="/professions/dashboard">Dashboard {{ Auth::user()->name }} </a>
          </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="/professions/index">
                        Beranda
                      </a>
                      <a class="dropdown-item" href="">
                        Profil Saya
